...
hl.define_submap("global", function()
  ...
  hl.bind("CTRL + SUPER + Delete", hl.dsp.global("quickshell:sessionToggle"), { desc = "Toggle session menu" })
  hl.bind("SUPER + J", hl.dsp.global("quickshell:barToggle"), { desc = "Toggle bar" })
  hl.bind("CTRL + SUPER + Delete", hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || pkill wlogout || wlogout -p layer-shell")))                              -- [hidden]
  hl.bind("SHIFT + SUPER + ALT + Slash", hl.dsp.exec_cmd("qs -p ~/.config/quickshell/" .. qsConfig .. "/welcome.qml"))                                -- [hidden]

  hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd(qsc("ipc call brightness increment || brightnessctl s 5%+")),
    { locked = true, repeating = true })                                                                                                              -- [hidden]
  hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(qsc("ipc call brightness decrement || brightnessctl s 5%-")),
    { locked = true, repeating = true })                                                                                                              -- [hidden]
  ...
  hl.bind("CTRL + SUPER + ALT + T", hl.dsp.global("quickshell:wallpaperSelectorRandom"),
    { desc = "Select random wallpaper" })
  hl.bind("CTRL + SUPER + T",
    hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || ~/.config/quickshell/" .. qsConfig .. "/scripts/colors/switchwall.sh")))                           -- [hidden]
  ...
  hl.bind("CTRL + SUPER + R",
    hl.dsp.exec_cmd("pkill ydotool; qs kill -c " ..
    qsConfig .. "; bash -c 'source /etc/set-environment 2>/dev/null; qs -c " .. qsConfig .. " &'"),
  ...
  hl.bind("SUPER + V",
    hl.dsp.exec_cmd(qsc(
    [[ipc call TEST_ALIVE || pkill fuzzel || cliphist list | fuzzel --match-mode fzf --dmenu | cliphist decode | wl-copy]])))                                        -- [hidden]
  hl.bind("SUPER + Period",
    hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || pkill fuzzel || ~/.config/hypr/hyprland/scripts/fuzzel-emoji.sh copy")))                                             -- [hidden]
  hl.bind("SUPER + SHIFT + S", hl.dsp.global("quickshell:regionScreenshot"), { desc = "Screen snip" })
  hl.bind("SUPER + SHIFT + S",
    hl.dsp.exec_cmd(qsc(
    "ipc call TEST_ALIVE || pidof slurp || hyprshot --freeze --clipboard-only --mode region --silent")))                                                             -- [hidden]
  hl.bind("SUPER + SHIFT + A", hl.dsp.global("quickshell:regionSearch"), { desc = "Google Lens" })
  hl.bind("SUPER + SHIFT + A",
    hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || pidof slurp || ~/.config/hypr/hyprland/scripts/snip_to_search.sh")))                                                 -- [hidden]
  ...
  hl.bind("SUPER + SHIFT + R", hl.dsp.global("quickshell:regionRecord"),
    { locked = true, desc = "Record region (no sound)" })
  hl.bind("SUPER + SHIFT + R",
    hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || ~/.config/quickshell/" .. qsConfig .. "/scripts/videos/record.sh")),
    { locked = true })                                                                                                                                             -- [hidden]
  ...
  hl.bind("SUPER + ALT + R",
    ...
    { locked = true })                                                                                                                                             -- [hidden]
  hl.bind("CTRL + ALT + R",
    hl.dsp.exec_cmd("~/.config/quickshell/" .. qsConfig .. "/scripts/videos/record.sh --fullscreen"), { locked = true })                                           -- [hidden]
  hl.bind("SUPER + SHIFT + ALT + R",
    hl.dsp.exec_cmd("~/.config/quickshell/" .. qsConfig .. "/scripts/videos/record.sh --fullscreen --sound"),
    { locked = true, desc = "Record screen (with sound)" })
  hl.bind("Print", hl.dsp.exec_cmd([[grim -o "$(hyprctl activeworkspace -j | jq -r '.monitor')" - | wl-copy]]),
    { locked = true, desc = "Screenshot >> clipboard" })
  hl.bind("SUPER + CTRL + Backspace",
    hl.dsp.exec_cmd(
    [[mkdir -p /home/$(whoami)/Pictures/Screenshots && grim -o "$(hyprctl activeworkspace -j | jq -r '.monitor')" /home/$(whoami)/Pictures/Screenshots/Screenshot_"$(date '+%Y-%m-%d_%H.%M.%S')".png]]),
    { locked = true, non_consuming = true, desc = "Screenshot >> clipboard & file" })
  hl.bind("SUPER + CTRL + Backspace",
    hl.dsp.exec_cmd([[grim -o "$(hyprctl activeworkspace -j | jq -r '.monitor')" - | wl-copy]]),
    { locked = true, non_consuming = true })                                                                                                                                    -- [hidden]
  hl.bind("SUPER + SHIFT + ALT + mouse:273",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/ai/primary-buffer-query.sh"),
    { desc = "Generate AI summary for selected text" })                                                                                                                         -- [hidden]
  ...
  hl.bind("SUPER + SHIFT + code:10",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 1"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:11",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 2"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:12",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 3"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:13",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 4"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:14",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 5"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:15",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 6"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:16",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 7"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:17",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 8"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:18",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 9"))                                   -- [hidden]
  hl.bind("SUPER + SHIFT + code:19",
    hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspace 10"))                                  -- [hidden]
  ...
  hl.bind("SUPER + l", hl.dsp.focus({ workspace = "r+1" }))                                                                                -- [hidden]
  hl.bind("SUPER + h", hl.dsp.focus({ workspace = "r-1" }))                                                                                -- [hidden]
  ...
  hl.bind("SUPER + code:82",
    hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || ~/.config/hypr/hyprland/scripts/zoom.sh decrease 0.1")),
    { repeating = true })                                                                                                                               -- [hidden]
  hl.bind("SUPER + code:86",
    hl.dsp.exec_cmd(qsc("ipc call TEST_ALIVE || ~/.config/hypr/hyprland/scripts/zoom.sh increase 0.1")),
    { repeating = true })                                                                                                                               -- [hidden]

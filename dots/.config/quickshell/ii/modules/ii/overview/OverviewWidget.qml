                    ...
                    MouseArea {
                        ...
                        onReleased: {
                            ...
                            if (targetWorkspace !== -1 && targetWorkspace !== windowData?.workspace.id) {
                                Hyprland.dispatch(`hl.dsp.window.move({workspace='${targetWorkspace}', silent=true, address='${window.windowData?.address}'})`)
                                ...
                                Hyprland.dispatch(`hl.dsp.window.move({x=${percentageX}, y=${percentageY}, address='${window.windowData?.address}'})`)
                            }
                        }
                        onClicked: (event) => {
